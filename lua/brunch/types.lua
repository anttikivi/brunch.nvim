...
---@alias BrunchColor 'rosewater' | 'grapefruit' | 'raspberry' | 'blackberry' | 'tomato' | 'cranberry' | 'peach' | 'mimosa' | 'kale' | 'aqua' | 'cornflower' | 'avocado' | 'blueberry' | 'lavender' | 'text' | 'subtext1' | 'subtext0' | 'overlay2' | 'overlay1' | 'overlay0' | 'surface2' | 'surface1' | 'surface0' | 'base' | 'mantle' | 'crust'
---@class BrunchVariants<T>: { all: T, sunday: T, saturday: T }
---@class BrunchColors<T>: { rosewater: T, grapefruit: T, raspberry: T, blackberry: T, tomato: T, cranberry: T, peach: T, mimosa: T, kale: T, aqua: T, cornflower: T, avocado: T, blueberry: T, lavender: T, text: T, subtext1: T, subtext0: T, overlay2: T, overlay1: T, overlay0: T, surface2: T, surface1: T, surface0: T, base: T, mantle: T, crust: T, none: T }
